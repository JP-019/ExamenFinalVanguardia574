...
• Debe realizar 1 commit por cada requisito completado (cada endpoint, cada
validación, cada regla de negocio, y uno para el documento de la segunda parte).
• Cada commit debe incluir únicamente los cambios de ese requisito.
• El mensaje debe indicar qué se implementó y cómo, con términos técnicos
